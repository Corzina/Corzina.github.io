...
::: {#hero-heading}
Greetings! I'm Ilya Fominykh, a Research Assistant at Utrecht University
with a strong passion for quantitative methodology in the social
sciences, Bayesian statistics, and survey data analysis. My research
interests encompass a diverse range of topics, including electoral
dynamics, regime transitions, individual values, and more.

I'm actively engaged in numerous research projects that align with my
expertise. Currently, I'm a dedicated member of a research groups
investigating the contemporary challenges associated with [democratic
backsliding](https://en.wikipedia.org/wiki/Democratic_backsliding).
Additionally, I'm actively contributing to projects that explore
Bayesian approaches in exploratory factor analysis.

Welcome to my developer portfolio, where you can explore my journey and
...
Science* \| 2022-ongoing

I am currently studying Bayesian statistics, machine learning, missing
data, and sparse data analysis and working on my thesis on combining
digital trace data and survey data for participation prediction.

**HIGHER SCHOOL OF ECONOMICS, MOSCOW** \| Bachelor in Political Science
\| *Track: Political Analysis* \| 2018-2022

I specialized in quantitative data for social sciences, survey data
analysis and structural equation modeling, graduated with honors, GPA
8.9

**VCIOM SOCIOLOGIC SCHOOL** \| Winter School \| *Track: Policy and
Market Analysis* \| 2022

I learned about the survey design and data collection, applying
knowledge to solve business cases.
